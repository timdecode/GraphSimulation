...
struct REGIONGROWING_API FHalfEdgeVertex
{
...
USTRUCT( BlueprintType )
struct REGIONGROWING_API FHullHalfEdge
{
    GENERATED_USTRUCT_BODY()
...
USTRUCT( BlueprintType )
struct REGIONGROWING_API FHalfEdgeHullFace
{
    GENERATED_USTRUCT_BODY()
...
struct REGIONGROWING_API HalfEdgeMesh
{
public:
